...
namespace BankOfBIT_TP.Controllers
{
    public class SavingsAccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BankAccountId,ClientId,AccountStateId,AccountNumber,Balance,DateCreated,Notes,SavingServiceCharges")] SavingsAccount savingsAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BankAccountId,ClientId,AccountStateId,AccountNumber,Balance,DateCreated,Notes,SavingServiceCharges")] SavingsAccount savingsAccount)
        {
            if (ModelState.IsValid)
            {
            ...
            ViewBag.AccountStateId = new SelectList(db.AccountStates, "AccountStateId", "AccountStateId", savingsAccount.AccountStateId);
            ViewBag.ClientId = new SelectList(db.Clients, "ClientId", "FullName", savingsAccount.ClientId);
            return View(savingsAccount);
        }
